...
import { handleFetchStock } from '../../services/SOAP';
  ...
  const handleFetch  = async () => {
    try {
      if (selectedDate) {
        ...
        const stockData = await handleFetchStock(selectedDate);
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mt: 4 }}>
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
              ...
              <Grid item xs={12}>
                <Button variant="contained" color="primary" onClick={handleFetch} fullWidth>
                  Fetch Stock Data
                </Button>
              </Grid>
